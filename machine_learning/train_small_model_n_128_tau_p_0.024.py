...
model_size = int(Y.shape[1]/reduce)
YTraining = YTraining[:,::reduce]
YValidation = YValidation[:,::reduce]
...
if gaussian_noise:
    model.save(global_filepath + 'trained_model_n_'+str(finite_width_params["N"])+"_tau_p_"+str(finite_width_params["tau_p"])+'_reduction_'+str(reduce)+'_noise_mu_'+str(mu)+'_sigma_'+str(sigma)+'.keras')
    print("Model saved to "+global_filepath + 'trained_model_reduction_'+str(reduce)+'_noise_mu_'+str(mu)+'_sigma_'+str(sigma)+'.keras')
else:
    model.save(global_filepath + 'trained_model_n_'+str(finite_width_params["N"])+"_tau_p_"+str(finite_width_params["tau_p"])+'_reduction_'+str(reduce)+'.keras')
    print("Model saved to "+global_filepath + 'trained_model_reduction_'+str(reduce)+'.keras')
...
plt.yscale('log')
if gaussian_noise:
    plt.savefig(global_filepath + 'training_history_model_n_'+str(finite_width_params["N"])+"_tau_p_"+str(finite_width_params["tau_p"])+'_reduction_'+str(reduce)+'_noise_mu_'+str(mu)+'_sigma_'+str(sigma)+'.png')  # Save the figure
    print("Training history figure saved to " + global_filepath + 'training_history_model_n_'+str(finite_width_params["N"])+"_tau_p_"+str(finite_width_params["tau_p"])+'_reduction_'+str(reduce)+'_noise_mu_'+str(mu)+'_sigma_'+str(sigma)+'.png')
else:
    plt.savefig(global_filepath + 'training_history_model_n'+str(finite_width_params["N"])+"_tau_p_"+str(finite_width_params["tau_p"])+'_reduction_'+str(reduce)+'.png')  # Save the figure
# plt.show()
    print("Training history figure saved to " + global_filepath + 'training_history_model_n'+str(finite_width_params["N"])+"_tau_p_"+str(finite_width_params["tau_p"])+'_reduction_'+str(reduce)+'.png')