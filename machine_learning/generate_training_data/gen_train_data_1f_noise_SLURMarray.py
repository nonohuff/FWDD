...
def make_and_save_training_data(t_points, save_every_n, noise_profile, *args, **kwargs):
    """
    ...
    **kwargs : dict
    ...
    with file_lock(output_path):
        try:
            ...
            print(f"Task {task_id}: Found {len(existing_params)} existing parameter sets.")
        except (FileNotFoundError, KeyError):
            print(f"Task {task_id}: No existing data file found.")
    ...
    new_parameters = [param for param in task_parameters if tuple(param) not in existing_params]
...
print(f_args)
print("****************************")
make_and_save_training_data(t_points,save_every_n,noise_spectrum_1f,*f_args,**finite_width_params)
