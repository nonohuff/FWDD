...
save_every_n = 10
print("Generating Training Data: Lorentzian Noise")
print(finite_width_params)
print()
print(lor_args)
print("****************************")
make_and_save_training_data(t_points,save_every_n,noise_spectrum_lor,*lor_args,**finite_width_params)