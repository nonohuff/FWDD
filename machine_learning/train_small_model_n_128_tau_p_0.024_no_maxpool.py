...
model.save(global_filepath + 'trained_model_n'+str(finite_width_params["N"])+"_tau_p_"+str(finite_width_params["tau_p"])+'reduction_'+str(reduce)+"_model_no_maxpool"+'.keras')
...
plt.yscale('log')
plt.savefig(global_filepath + 'training_history_model_n'+str(finite_width_params["N"])+"_tau_p_"+str(finite_width_params["tau_p"])+'reduction_'+str(reduce)+'_model_no_maxpool.png')  # Save the figure
# plt.show()
